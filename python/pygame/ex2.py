...
def main():
    ...
    pygame.display.set_caption(u"animation")
 
    all = pygame.sprite.RenderUpdates()
    Character.containers = all
    
    player = Character("Funa01.png", 45, 0, 195)
    player2 = Character("Funa01.png", 0, 70, 65)
    player3 = Character("Funa01.png", 90, 70, 130)
    player4 = Character("Funa01.png", 45, 140, 0)
